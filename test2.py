...
def test_activity_feed():
    ...
    r = requests.get('https://skillswitch-djzpurkahq-ew.a.run.app:8000/activity_feed', json=arguments)
    print('ACTIVITY_FEED:')
    print(r.json())
...
def test_active_jobs_in_regions():
    ...
    r = requests.get('https://skillswitch-djzpurkahq-ew.a.run.app:8000/active_jobs_in_region', json=arguments)
...
def test_completed_jobs_by_user():
    ...
    r = requests.get('https://skillswitch-djzpurkahq-ew.a.run.app:8000/completed_jobs_by_user', json=arguments)
...
def test_accepted_jobs_by_user():
    ...
    r = requests.get('https://skillswitch-djzpurkahq-ew.a.run.app:8000/accepted_jobs_by_user', json=arguments)
...
def test_liked_jobs_by_user():
    ...
    r = requests.get('https://skillswitch-djzpurkahq-ew.a.run.app:8000/liked_jobs_by_user', json=arguments)
...
def test_owned_jobs_by_user():
    ...
    r = requests.get('https://skillswitch-djzpurkahq-ew.a.run.app:8000/jobs_owned_by_user', json=arguments)
...
def test_all_users_in_region():
    ...
    r = requests.get('https://skillswitch-djzpurkahq-ew.a.run.app:8000/all_users_in_region', json=arguments)
...
def test_search_jobs():
    ...
    for type, search in zip(diff_types, diff_search):
        ...
        r = requests.get('https://skillswitch-djzpurkahq-ew.a.run.app:8000/search_jobs', json=arguments)
...
def test_search_users():
    ...
    for type, search in zip(diff_types, diff_search):
        ...
        r = requests.get('https://skillswitch-djzpurkahq-ew.a.run.app:8000/search_users', json=arguments)
...
def test_match_jobs():
    ...
    r = requests.get('https://skillswitch-djzpurkahq-ew.a.run.app:8000/match_jobs', json=arguments)
    print('MATCHED_JOBS:')
    print(r.json())
    print('______________________________________________')
...
def test_insert_or_update_user():
    ...
    r = requests.post('https://skillswitch-djzpurkahq-ew.a.run.app:8000/user', json=arguments)
    print('USER1:')
    print(r)
    print(r.json())
    print('______________________________________________')
...
def test_change_user_name():
    ...
    r = requests.post('https://skillswitch-djzpurkahq-ew.a.run.app:8000/change_user_name', json=arguments)
...
def test_insert_or_update_job():
    ...
    r = requests.post('https://skillswitch-djzpurkahq-ew.a.run.app:8000/job', json=arguments)
    print('JOB1:')
    print(r)
    print(r.json())
    print('______________________________________________')
...
def test_change_job_title():
    ...
    r = requests.post('https://skillswitch-djzpurkahq-ew.a.run.app:8000/change_job_title', json=arguments)
...
def test_change_job_region():
    ...
    r = requests.post('https://skillswitch-djzpurkahq-ew.a.run.app:8000/change_job_region', json=arguments)
...
def test_user_liked_job():
    ...
    r = requests.post('https://skillswitch-djzpurkahq-ew.a.run.app:8000/user_liked_job', json=arguments)
...
def test_user_unliked_job():
    ...
    r = requests.post('https://skillswitch-djzpurkahq-ew.a.run.app:8000/user_unliked_job', json=arguments)
...
def test_user_accepted_job():
    ...
    r = requests.post('https://skillswitch-djzpurkahq-ew.a.run.app:8000/user_accepted_job', json=arguments)
...
def test_user_completed_job():
    ...
    r = requests.post('https://skillswitch-djzpurkahq-ew.a.run.app:8000/user_completed_job', json=arguments)
...
def test_user_not_completed_job():
    ...
    r = requests.post('https://skillswitch-djzpurkahq-ew.a.run.app:8000/user_not_complete_job', json=arguments)
...
def test_user_receive_rating():
    ...
    r = requests.post('https://skillswitch-djzpurkahq-ew.a.run.app:8000/user_received_rating', json=arguments)
